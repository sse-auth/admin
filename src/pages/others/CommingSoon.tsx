...
const CommingSoon: React.FC<TimeProps> = ({ days, hours, minute, second }) => {
    ...
    return (
        <>
                    ...
                    <div className="no-scrollbar overflow-y-auto py-20">
                        <div className="mx-auto w-full max-w-[600px]">
                            <div className="text-center">
                                ...
                                <h1 className="mb-2.5 text-3xl font-black text-black dark:text-white lg:text-4xl xl:text-[50px] xl:leading-[60px]">Comming Soon</h1>
                                <p className="font-medium">Our website is currently under construction, enter your email id to get latest updates and notifications about the website.</p>
                            </div>
                        </div>
                        ...
                        <div className="mx-auto mt-12.5 w-full max-w-[580px]">
                            <form>
                                <div className="flex">
                                    ...
                                    <button type="submit" className="inline-flex justify-center rounded-r-md bg-primary px-4 py-3 font-medium text-white duration-200 ease-out hover:bg-opacity-90 sm:px-7.5">Subscribe</button>
                                </div>
                            </form>
                        </div>
            ...
            <svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;"><defs id="SvgjsDefs1002"></defs><polyline id="SvgjsPolyline1003" points="0,0"></polyline><path id="SvgjsPath1004" d="M-1 232.348L-1 232.348L49.39106889204546 232.348L98.78213778409092 232.348L148.17320667613637 232.348L197.56427556818184 232.348L246.95534446022728 232.348L296.34641335227275 232.348L345.7374822443182 232.348L395.1285511363637 232.348L444.5196200284091 232.348L493.91068892045456 232.348L543.3017578125 232.348C543.3017578125 232.348 543.3017578125 232.348 543.3017578125 232.348 "></path></svg>
            <div className="jvm-tooltip"></div>
        </>
    )
}
